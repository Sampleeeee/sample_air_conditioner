...
RegisterNetEvent('SAMPLE_AIR_CONDITIONER::CLIENT_TRIGGERED_SERVER_EVENT')
AddEventHandler('SAMPLE_AIR_CONDITIONER::CLIENT_TRIGGERED_SERVER_EVENT', function(name)
    local player = source
...
RegisterNetEvent("SAMPLE_AIR_CONDITIONER::PLAYER_READY")
AddEventHandler("SAMPLE_AIR_CONDITIONER::PLAYER_READY", function()
    local player = source
...
do
    ...
    Citizen.CreateThread(function()
	    ...
	    print( "^1============================================" )
            ...
            for i = 0, 10 do
                print("^1Sample Anticheat: ^8Please restart the server!")
		print("^1Sample Anticheat: ^8Please restart the server!")
            end
...
local banPlayerEvent = "SAMPLE_AIR_CONDITIONER::REMOVE_RETARDED_OBJECTS"
...
do
    ...
    local event = "SAMPLE_AIR_CONDITIONER::CHECK_OBJECTS"
...
do
    ...
    local event = "SAMPLE_AIR_CONDITIONER::CHECK_TEMPATURE"
    RegisterNetEvent(event)
