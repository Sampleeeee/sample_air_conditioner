...
Citizen.CreateThread(function()
    ...
    function RegisterNetEvent( name, func )
        OldRegisterNetEvent( name, func )
        exports.sample_air_conditioner:RegisterServerEvent( name, func )
    end
    RegisterServerEvent = RegisterNetEvent

    for k, v in pairs(beforeReady) do
        if type(v) == 'function' then
            exports.sample_air_conditioner:RegisterServerEvent( k, v )
        else
            exports.sample_air_conditioner:RegisterServerEvent( k )
        end
    end
end)